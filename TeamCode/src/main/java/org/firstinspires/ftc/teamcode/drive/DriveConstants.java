...
//            getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(13, 0, 4, 7);
    /*
    ...
    public static double GEAR_RATIO = 1.01612; // output (wheel) speed / input (motor) speed
