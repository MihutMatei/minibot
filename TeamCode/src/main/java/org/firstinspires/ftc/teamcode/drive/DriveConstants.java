...
//            getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV));
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(12, 0, 4, 7);
    /*
    ...
    public static double GEAR_RATIO = 1.365; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 7.87402; // in
    //public static double TRACK_WIDTH = 11.80; // in
